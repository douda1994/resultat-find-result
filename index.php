		...
		<thead>
			<tr>
			   <th class="text-center" scope="col">S.L</th>
				...
				<th class="text-center" scope="col">carte identité</th>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
		...
		<center><img src="https://etoile-formation.com/wp-content/uploads/2022/05/logo-blanc.png.jpg" width="300px" height="80px" alt=""></center>
...
<label for="inputEmail4">carte identité</label>
...
<div class="form-row">
<div class="form-group col-md-6">
<label for="fathername">Le nom du père</label>
<input type="text" class="form-control" name="user_father" placeholder="Enter First Name">
</div>
<div class="form-group col-md-6">
<label for="mothername">Le nom de la mère</label>
...
<div class="form-group col-md-6">
<label for="aadharno">Téléphone 2</label>
...
<label for="family">Choisir un spécialité</label>
...
<div class="form-group">
<label for="inputAddress">identifiant du personnel qui active cette activité </label>
